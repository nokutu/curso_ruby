class ProductsController < ApplicationController
  ...
  def destroy
    @product.destroy
    respond_to do |format|
      format.html { redirect_to products_url, notice: 'El producto fue destruido correctamente.' }
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :description, :reference, :price, :stock)
    end
end
