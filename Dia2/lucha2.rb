TABLA = {
  ...
  ['Kicker', :prob_manos]     => 0,
  ['Kicker', :fuerza_piernas] => 11,
  ['Kicker', :prob_piernas]   => 1,
  ['Kicker', :prob_esquivar]  => 0
}
...
Combate.new([Boxeador.new, Karateka.new, Kicker.new, Boxeador.new,
             Karateka.new, Ninja.new]).iniciar
